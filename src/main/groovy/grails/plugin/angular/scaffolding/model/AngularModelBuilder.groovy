...
import grails.plugin.angular.scaffolding.model.AngularModelBuilder.AngularModelImpl
...
trait AngularModelBuilder {
    ...
    private static class AngularModelImpl implements AngularModel {
        ...
        AngularModel getParentModule() {
            println "parent module \"${basePath}/${this.packagePath}/${this.packageName}.js\""
